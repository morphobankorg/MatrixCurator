...
from src.integrations.posthog import init_posthog, capture_event, DEFAULT_POSTHOG_KEY
import src.integrations.posthog as posthog_module

@patch("src.integrations.posthog.posthog")
@patch("src.integrations.posthog.settings")
