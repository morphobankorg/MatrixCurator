...
@patch("src.modules.document.services.read_pdf")
...
@patch("src.modules.document.services.read_docx")
...
@patch("src.modules.document.services.read_txt")
...
@patch("src.modules.document.services.write_nexus")
