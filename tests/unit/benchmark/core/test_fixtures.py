...
from src.benchmark.core.fixtures import resolve_fixtures

@pytest.fixture
def mock_get_fixtures():
    with patch("src.benchmark.core.fixtures.get_fixtures", spec=True) as mock:
        yield mock
...
async def test_resolve_fixtures_concurrency(mock_get_fixtures):
    ...
    from src.benchmark.core.fixtures import _SESSION_LOCKS
