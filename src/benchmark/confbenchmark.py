...
from src.benchmark.core.decorators import fixture
from matrixcurator.config.main import settings as core_settings
from src.benchmark.config.main import settings as benchmark_settings
import matrixcurator.modules.retrieval.repositories.sqlite as sqlite_repo

from src.benchmark.modules.dataset.services import preparse_documents, sync_datasets
from src.benchmark.modules.evaluation.services import setup_evaluators
import src.benchmark.modules.dataset.repositories.langfuse as langfuse_repo
import src.benchmark.modules.dataset.repositories.parquet as parquet_repo
from src.benchmark.modules.retrieval.services import auto_ingest_vectors
...
async def fixture_synced_langfuse(skip_sync: bool, lf_client: Any, fixture_parsed_cache):
    if not skip_sync and lf_client:
        await sync_datasets(parquet_repo, langfuse_repo, lf_client, fixture_parsed_cache)
        setup_evaluators(langfuse_repo, lf_client)
    return True
