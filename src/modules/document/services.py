...
from src.modules.document.repositories.docx import read_docx
from src.modules.document.repositories.txt import read_txt
from src.modules.document.repositories.nexus import write_nexus
